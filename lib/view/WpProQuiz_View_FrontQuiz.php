	...
	private function showResultBox( $result, $questionCount ) {
		...
		<div style="display: none;" class="wpProQuiz_results">
			...
			<div class="rzQuiz_text">
				...
				<?php if ( ! $this->quiz->isHideResultPoints() ) { ?>
					<span class="wpProQuiz_points"><?php printf( __( 'Vous avez obtenu <strong>%s points sur %s</strong>', 'wp-pro-quiz' ), '<span>0</span>', '<span>0</span>' ) ?></span>
				<?php } ?>

				<div class="publicFacebook_block">
				...
				<div id="share-success"><?php _e ( 'Score partagé sur facebook avec succès !', 'wp-pro-quiz' ) ?></div>
			</div>
			<div class="wpProQuiz_bottom">
				...
				<div class="wpProQuiz_button_block">
					<?php
					if ( ! $this->quiz->isBtnViewQuestionHidden() ) { ?>
						<input class="wpProQuiz_button" type="button" name="reShowQuestion"
						       value="<?php _e( 'Voir les réponses', 'wp-pro-quiz' ); ?>">
					<?php } ?>
					<a href="/services-gratuits/quizz" class="wpProQuiz_button doAQuiz"><?php _e( 'Faire un autre quiz' ) ?></a>
		...
		<script>
			...
			function streamPublish() {
				...
				var quizScore = jQuery('#rzQuiz_score_value').text();
									...
									jQuery.post(
										...
										function (response) {
											...
											FB.api(
												...
												function (response) {
													jQuery('#share-success').css('display', 'block');
												}
											);
										}
									);
								...
								<div style="display: none;" class="wpProQuiz_correct">
									...
									<span style="float: left;" class="wpProQuiz_respone_span">
										<?php _e( 'Correct', 'wp-pro-quiz' ); ?>
											...
											<span
												style="float: right;"><?php echo $question->getPoints() . ' / ' . $question->getPoints(); ?><?php _e( 'Points', 'wp-pro-quiz' ); ?></span>
									...
									<span style="float: left;" class="wpProQuiz_respone_span">
										<?php _e( 'Incorrect', 'wp-pro-quiz' ); ?>
											...
											<span style="float: right;"><span
													class="wpProQuiz_responsePoints"></span> / <?php echo $question->getPoints(); ?> <?php _e( 'Points', 'wp-pro-quiz' ); ?></span>
